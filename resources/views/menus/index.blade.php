            ...
            <div class="w-full md:w-64 overflow-y-scroll" style="max-height: 60vh;">
                ...
                <div class="bg-white rounded-lg p-4 mb-4">
                    ...
                    <div class="text-center border-t pt-4">
                        <button onclick="openCart()" class="bg-sky-500 text-white px-4 py-2 rounded-lg hover:bg-sky-600">
                            Lihat Keranjang
                        </button>
                        <p class="text-gray-500 mt-2">Total: <span id="cartTotal">Rp 0,00</span></p>
